...
(function(){
  ...
  function updateGenreCounts() {
    document.querySelectorAll('.genre-card').forEach(card => {
      ...
      const countEl = card.querySelector('.genre-count');
      if (!countEl) return;
  ...
  // Genre grid/carousel clicks map to the same tag system
  document.addEventListener('click', (e)=>{
    const g = e.target.closest('.genre-wheel .gw-node, .genre-card'); if (!g) return;
    ...
    .catch(error => {
      ...
      if (isScoped){
        const fallbackScoped = [
          { id:'scoped_sample', title:'Sample', artist:'Project audio', cover:'assets/images/covers/NotTodayAudio.png', tags:['all'], length:0, date:'2025-01-01', year:2025, sources:[ { url:'assets/audio/tracks/placeholder.wav', type:'audio/wav' } ] }
        ];
      ...
      const fallbackTracks = [
        { id:'ray', title:'Ray Animation — Credits Theme', artist:'Igor Szuniewicz', cover:'assets/images/covers/project5.png', tags:['film','score'], length: 0, date:'2024-01-10', year: 2024, desc:{ pl:'Funkowo zabarwiony cue do animacji. Lekki groove i figury basu prowadzą do świetlistej kadencji domykającej ujęcie. Brzmienie klarowne, z wyraźnym motywem i sprężystą sekcją.', en:'Funk‑tinged cue for animation. A light groove and bass figures steer the piece towards a luminous cadence that closes the shot. Clean tone with a recognisable motif and elastic rhythm section.', nl:'Funk‑getinte cue voor animatie. Lichte groove en basfiguren bouwen naar een lichtvolle cadens die de scène afrondt. Helder klankbeeld met herkenbaar motief en veerkrachtige ritmesectie.' }, sources:[ { url:'assets/audio/tracks/RayCreditsTheme.wav', type:'audio/wav' } ] },
        { id:'richter', title:'Richter — Main Theme', artist:'Igor Szuniewicz', cover:'assets/images/covers/richter.png', tags:['film','score'], length: 0, date:'2024-06-01', year: 2024, desc:{ pl:'Sekwencja suspensu do etiudy filmowej: warstwowe smyczki i perkusja akcji wymuszają stałe narastanie, zakończone zdecydowanym, filmowym cięciem.', en:'Suspense sequence for a short film: layered strings and action percussion drive a continuous escalation, resolved with a decisive cinematic cutoff.', nl:'Suspense‑cue voor een korte film: gelaagde strijkers en actiedrums stuwen een constante opbouw, afgesloten met een beslissende filmische stop.' }, sources:[ { url:'assets/audio/tracks/RichterMainTheme.wav', type:'audio/wav' }, { url:'assets/audio/tracks/RichterMainTheme.m4a', type:'audio/mp4' }, { url:'assets/audio/tracks/RichterMainTheme.mp3', type:'audio/mpeg' } ] },
        { id:'obsidian', title:'Obsidian', artist:'Igor Szuniewicz', cover:'assets/images/covers/Tribal.png', tags:['techno','electronic'], length: 0, date:'2023-01-01', year: 2023, desc:{ pl:'Hipnotyczny techno z głębokimi basami i rytmicznymi motywami. Ciemne syntezatory tworzą hipnotyczną atmosferę.', en:'Hypnotic techno with deep bass and rhythmic motifs. Dark synthesizers create a mesmerizing atmosphere.', nl:'Hypnotische techno met diepe bas en ritmische motieven. Donkere synthesizers creëren een hypnotiserende sfeer.' }, sources:[ { url:'assets/audio/tracks/trans2.wav', type:'audio/wav' } ] },
        { id:'sp_inflow', title:'Inflow', artist:'Igor Szuniewicz', cover:'assets/images/covers/Inflow_track_cover.jpg', tags:['single','electronic'], length: 0, date:'2023-01-01', year: 2023, desc:{ pl:'Kameralny temat fortepianowy, który organicznie rozszerza się do pełnej orkiestracji smyczkowej. Delikatna ekspozycja motywu prowadzi do szerokiej, filmowej kulminacji.', en:'A chamber piano theme that expands organically into full string orchestration. A delicate exposition evolves towards a broad, cinematic climax.', nl:'Een kamerpianothema dat organisch uitgroeit tot volledige strijkerorkestratie. Een fragiele expositie groeit naar een brede, filmische climax.' }, sources:[ { url:'assets/audio/tracks/Igor Szuniewicz - Inflow.wav', type:'audio/wav' }, { url:'assets/audio/tracks/Inflow.m4a', type:'audio/mp4' }, { url:'assets/audio/tracks/Inflow.mp3', type:'audio/mpeg' } ] },
        { id:'sp_astro', title:'Astrophonic Dance', artist:'Igor Szuniewicz', cover:'assets/images/covers/Astrophonic Dance_track_cover.jpg', tags:['single','electronic'], length: 0, date:'2023-01-01', year: 2023, desc:{ pl:'Uptempo elektronika z arpeggiowanymi leadami i szeroką sceną stereo. Syntetyczne faktury łączą się z taneczną pulsacją i lekką, przestrzenną produkcją.', en:'Uptempo electronica with arpeggiated leads and a wide stereo image. Synthetic textures meet a dance‑oriented pulse and spacious production.', nl:'Uptempo electronica met arpeggio‑leads en breed stereobeeld. Synthetische texturen combineren met een dansgerichte puls en luchtige productie.' }, sources:[ { url:'assets/audio/tracks/Igor Szuniewicz - Astrophonic Dance.wav', type:'audio/wav' }, { url:'assets/audio/tracks/AstrophonicDance.m4a', type:'audio/mp4' }, { url:'assets/audio/tracks/AstrophonicDance.mp3', type:'audio/mpeg' } ] },
        { id:'sp_cathedral', title:'Cathedral Of Time', artist:'Igor Szuniewicz', cover:'assets/images/covers/Cathedral Of Time_track_cover.jpg', tags:['single','electronic'], length: 0, date:'2023-01-01', year: 2023, desc:{ pl:'Wolnorozwijające się, filmowo‑elektroniczne pejzaże: ciepłe harmonie, duża przestrzeń i kontemplacyjny nastrój podtrzymywany stabilnym pulsem.', en:'Slow‑bloom cinematic‑electronic soundscapes: warm harmonies, generous space and a contemplative mood sustained by a steady pulse.', nl:'Langzaam ontvouwende filmisch‑elektronische landschappen: warme harmonieën, veel ruimte en een contemplatieve sfeer met constante puls.' }, sources:[ { url:'assets/audio/tracks/Igor Szuniewicz - Cathedral Of Time.wav', type:'audio/wav' }, { url:'assets/audio/tracks/CathedralOfTime.m4a', type:'audio/mp4' }, { url:'assets/audio/tracks/CathedralOfTime.mp3', type:'audio/mpeg' } ] },
        { id:'xianclash', title:'Xian Clash — Main Theme', artist:'Igor Szuniewicz', cover:'assets/images/covers/XianClashCover.png', tags:['film','score'], length: 0, date:'2024-02-10', year: 2024, desc:{ pl:'Temat do strategicznej gry planszowej: marszowa perkusja, modalne melodie i orkiestracyjna skala budują ceremoniálną potęgę i poczucie taktycznej koncentracji.', en:'Main theme for a strategy title: martial percussion, modal melodies and orchestral scale to convey ceremonial power and tactical focus.', nl:'Hoofdthema voor een strategiespel: marspercussie, modale melodieën en orkestrale schaal voor ceremoniële kracht en tactische focus.' }, sources:[ { url:'assets/audio/tracks/XianClashMainTheme.wav', type:'audio/wav' }, { url:'assets/audio/tracks/XianClashMainTheme.m4a', type:'audio/mp4' }, { url:'assets/audio/tracks/XianClashMainTheme.mp3', type:'audio/mpeg' } ] },
        { id:'run', title:'Run — Main Theme', artist:'Igor Szuniewicz', cover:'assets/images/covers/Run.png', tags:['single','metal'], length: 0, date:'2025-02-11', year: 2025, desc:{ pl:'Energetyczny rock oparty na ciężkich, nisko strojonych riffach i zwartym groove\'u sekcji rytmicznej. Produkcja nastawiona na impakt i nieprzerwany pęd.', en:'High‑energy rock built on down‑tuned riffs and a tight rhythmic groove. Production focuses on impact and sustained forward momentum.', nl:'Energieke rock op basis van laag gestemde riffs en strakke ritmische groove. Productie gericht op impact en aanhoudende vaart.' }, sources:[ { url:'assets/audio/tracks/RunMainTheme.wav', type:'audio/wav' }, { url:'assets/audio/tracks/RunMainTheme.m4a', type:'audio/mp4' }, { url:'assets/audio/tracks/RunMainTheme.mp3', type:'audio/mpeg' } ] },
        { id:'edgeoflife', title:'Edge Of Life', artist:'Igor Szuniewicz', cover:'assets/images/covers/EdgeOfLife.png', tags:['single','electronic','playful'], length: 0, date:'2024-06-01', year: 2024, sources:[ { url:'assets/audio/tracks/EdgeOfLife.wav', type:'audio/wav' } ], desc:{ pl:'Uplifting indie‑electronica: jasne pianino, pulsujące syntezatory i afirmacyjna progresja. Czyste, przestrzenne brzmienie akcentuje pozytywną energię utworu.', en:'Uplifting indie‑electronic piece: bright piano, pulsing synths and an affirmative progression. Clean, spacious mix emphasises the track\'s positive energy.', nl:'Opbeurende indie‑electronica: helder piano, pulserende synths en affirmatieve progressie. Een heldere, ruimtelijke mix benadrukt de positieve energie.' } },
        { id:'cage', title:'Cage', artist:'Igor Szuniewicz', cover:'assets/images/covers/Cage.png', tags:['single','metal'], length: 0, date:'2025-02-15', year: 2025, sources:[ { url:'assets/audio/tracks/Cage.wav', type:'audio/wav' } ], desc:{ pl:'Jeden z moich najmocniejszych utworów — industrial metal / hard rock: ciężkie gitary, masywny groove i surowa energia.', en:'One of my heaviest tracks — industrial metal / hard rock: heavy guitars, massive groove and raw energy.', nl:'Een van mijn hardste tracks — industrial metal / hard rock: zware gitaren, massieve groove en rauwe energie.' } },
        { id:'thatsit_cover', title:"That's It — Cover", artist:'Igor Szuniewicz', cover:'assets/images/covers/ThatsItCover.png', tags:['all','single','jazz'], length: 0, date:'2025-09-16', year: 2025, desc:{ pl:"Remix utworu 'That's It' zespołu Preservation Hall Jazz Band w stylistyce new jazz — w duchu tego, co zrobiono z 'Cantaloupe Island' tworząc 'Cantaloop'.", en:"A new‑jazz remix of 'That's It' by Preservation Hall Jazz Band — in the spirit of how 'Cantaloupe Island' became 'Cantaloop'.", nl:"Een new‑jazz‑remix van 'That's It' van Preservation Hall Jazz Band — in de geest van hoe 'Cantaloupe Island' veranderde in 'Cantaloop'." }, sources:[ { url:'assets/audio/tracks/ThatsItIgorSzuniewicz.wav', type:'audio/wav' } ] },
        { id:'gnosienne1', title:'Gnosienne No. 1 (Cover by Igor Szuniewicz)', artist:'Igor Szuniewicz', cover:'assets/images/covers/GnosienneAlbumCover.png', tags:['single','metal'], length: 0, date:'2025-09-16', year: 2025, sources:[ { url:'assets/audio/tracks/gnosienne1.wav', type:'audio/wav' } ] },
        { id:'psy', title:'Psy', artist:'Igor Szuniewicz', cover:'assets/images/covers/PSY.png', tags:['single','metal'], length: 0, date:'2025-09-15', year: 2025, desc:{ pl:'Utwór o cierpieniu psów trzymanych w niewoli i źle traktowanych przez właścicieli. Krzyk sprzeciwu wobec przemocy wobec zwierząt, pokazujący ich ból i bezsilność. Jednocześnie niesie przekaz, że czasem los wymierza sprawiedliwość oprawcom, a cierpienie wraca do tych, którzy je zadają.', en:'A piece about the suffering of dogs kept in captivity and abused by their owners. A cry of protest against violence towards animals, exposing their pain and powerlessness. At the same time it carries the message that fate sometimes delivers justice to the tormentors, and suffering returns to those who inflict it.', nl:'Een stuk over het lijden van honden die in gevangenschap worden gehouden en door hun eigenaars worden mishandeld. Een schreeuw van protest tegen geweld jegens dieren, die hun pijn en onmacht toont. Tegelijk draagt het de boodschap dat het lot soms gerechtigheid brengt voor de beulen en dat het leed terugkeert naar wie het toebrengt.' }, sources:[ { url:'assets/audio/tracks/psy(2).wav', type:'audio/wav' } ] },
        { id:'caplanetechno', title:'Ça Plane Pour Moi — Techno Remix', artist:'Igor Szuniewicz', cover:'assets/images/covers/caplanepourmoi.png', tags:['single','techno','electronic','remix'], length: 0, date:'2023-12-15', year: 2023, desc:{ pl:'Techno‑remix klasyka \'Ça plane pour moi\': szybki beat, sprężysty bas i energetyczne syntezatory.', en:'Techno remix of the classic \'Ça plane pour moi\': fast four‑on‑the‑floor, punchy bass and energetic synths.', nl:'Techno‑remix van de klassieker \'Ça plane pour moi\': snel vier‑op‑de‑vloer, stevige bas en energieke synths.' }, sources:[ { url:'assets/audio/tracks/caplanetechno.wav', type:'audio/wav' } ] },
        { id:"syncopation", title:"Syncopation$", artist:"Igor Szuniewicz", cover:"assets/images/covers/Syncopations.png", tags:["techno","electronic"], length: 0, date:"2024-01-01", year: 2024, desc:{ pl:"Hipnotyczny utwór techno ze złożonymi synkopowanymi rytmami i głębokimi liniami basu tworzącymi skomplikowane doświadczenie taneczne", en:"Hypnotic techno track with complex syncopated rhythms and deep basslines that create an intricate dance floor experience", nl:"Hypnotische techno track met complexe syncopische ritmes en diepe baslijnen die een ingewikkelde dansvloer ervaring creëren" }, sources:[ { url:"assets/audio/tracks/syncopationsnew.wav", type:'audio/wav' } ] }
      ];
  ...
  try { layoutAlbumWall(); } catch(_){}
    ...
    function startMarquee(strip, dir){
        if (!strip) return;
        if (strip.__marqueeRunning) return; // prevent multiple rAF loops
        strip.__marqueeRunning = true;
      let x = strip.__marqueeX || 0; const speed = dir > 0 ? 0.25 : -0.25; // px per frame approx (60fps)
        function step(){
        x += speed; strip.__marqueeX = x; strip.style.transform = 'translateX(' + x + 'px)';
