  ...
  fetch(tracksUrl, { cache: 'no-store' })
    ...
    .catch(error => {
      ...
      const fallbackTracks = [
        ...
        { id:'thatsit_cover', title:"That's It — Cover", artist:'Igor Szuniewicz', cover:'images/ThatsItCover.png', tags:['all','single','jazz'], length: 0, date:'2025-09-16', year: 2025, desc:{ pl:"Remix utworu 'That's It' zespołu Preservation Hall Jazz Band w stylistyce new jazz — w duchu tego, co zrobiono z 'Cantaloupe Island' tworząc 'Cantaloop'.", en:"A new‑jazz remix of 'That's It' by Preservation Hall Jazz Band — in the spirit of how 'Cantaloupe Island' became 'Cantaloop'.", nl:"Een new‑jazz‑remix van 'That's It' van Preservation Hall Jazz Band — in de geest van hoe 'Cantaloupe Island' veranderde in 'Cantaloop'." }, sources:[ { url:'songs/ThatsItIgorSzuniewicz.wav', type:'audio/wav' } ] },
        { id:'gnosienne1', title:'Gnosienne No. 1 (Cover by Igor Szuniewicz)', artist:'Igor Szuniewicz', cover:'images/GnosienneAlbumCover.png', tags:['single','metal'], length: 0, date:'2025-09-16', year: 2025, sources:[ { url:'songs/gnosienne1.wav', type:'audio/wav' } ] },
        { id:'psy', title:'Psy', artist:'Igor Szuniewicz', cover:'images/PSY.png', tags:['single','metal'], length: 0, date:'2025-09-15', year: 2025, desc:{ pl:'Utwór o cierpieniu psów trzymanych w niewoli i źle traktowanych przez właścicieli. Krzyk sprzeciwu wobec przemocy wobec zwierząt, pokazujący ich ból i bezsilność. Jednocześnie niesie przekaz, że czasem los wymierza sprawiedliwość oprawcom, a cierpienie wraca do tych, którzy je zadają.', en:'A piece about the suffering of dogs kept in captivity and abused by their owners. A cry of protest against violence towards animals, exposing their pain and powerlessness. At the same time it carries the message that fate sometimes delivers justice to the tormentors, and suffering returns to those who inflict it.', nl:'Een stuk over het lijden van honden die in gevangenschap worden gehouden en door hun eigenaars worden mishandeld. Een schreeuw van protest tegen geweld jegens dieren, die hun pijn en onmacht toont. Tegelijk draagt het de boodschap dat het lot soms gerechtigheid brengt voor de beulen en dat het leed terugkeert naar wie het toebrengt.' }, sources:[ { url:'songs/psy(2).wav', type:'audio/wav' } ] },
        { id:'caplanetechno', title:'Ça Plane Pour Moi — Techno Remix', artist:'Igor Szuniewicz', cover:'images/caplanepourmoi.png', tags:['single','techno','electronic','remix'], length: 0, date:'2023-12-15', year: 2023, desc:{ pl:'Techno‑remix klasyka \'Ça plane pour moi\': szybki beat, sprężysty bas i energetyczne syntezatory.', en:'Techno remix of the classic \'Ça plane pour moi\': fast four‑on‑the‑floor, punchy bass and energetic synths.', nl:'Techno‑remix van de klassieker \'Ça plane pour moi\': snel vier‑op‑de‑vloer, stevige bas en energieke synths.' }, sources:[ { url:'songs/caplanetechno.wav', type:'audio/wav' } ] },
        { id:"syncopation", title:"Syncopation$", artist:"Igor Szuniewicz", cover:"images/Syncopations.png", tags:["techno","electronic"], length: 0, date:"2024-01-01", year: 2024, desc:{ pl:"Hipnotyczny utwór techno ze złożonymi synkopowanymi rytmami i głębokimi liniami basu tworzącymi skomplikowane doświadczenie taneczne", en:"Hypnotic techno track with complex syncopated rhythms and deep basslines that create an intricate dance floor experience", nl:"Hypnotische techno track met complexe syncopische ritmes en diepe baslijnen die een ingewikkelde dansvloer ervaring creëren" }, sources:[ { url:"songs/syncopationsnew.wav", type:'audio/wav' } ] }
      ];
