  ...
  function translatePage(lang){
    ...
    if (location.pathname.endsWith('/about.html') || document.querySelector('.about-hero')){
      const A = {
        ...
        about_paragraph: {
          en:'My passion for audio started with my dad blasting rock classics at home — that\'s where I first fell in love with music. My parents signed me up for music school, and for 6 years I was often forced to practice piano. The school was brutal, like something from the communist era — strict teachers, impossible standards. I nearly had a mental breakdown from the pressure, but it taught me discipline. Sport has always been a huge part of my life — I\'ve loved swimming since forever, played volleyball throughout elementary and high school where I got properly trained, and only started hitting the gym after moving to Belgium (fell in love with it). In high school, I discovered my love for games while studying math, physics, and computer science. I started making scripts to get unfair advantages — first in Minecraft, then CS:GO, then whatever mainstream game I was playing. I loved automating things with Python and Lua scripts. Then I found this amazing video by Dr. Alexander Deweppe about the Game Sound Integration program in Belgium. I decided to risk everything and travel 1400 km from Poland to West Flanders. Best decision ever.',
          pl:'Moja pasja do audio zaczęła się od tego, że tata puszczał mi rockowe klasyki — wtedy po raz pierwszy zakochałem się w muzyce. Rodzice zapisali mnie do szkoły muzycznej i przez 6 lat często byłem zmuszany do gry na fortepianie. Szkoła była brutalna, jak z czasów PRL-u — surowi nauczyciele, niemożliwe wymagania. Prawie załamałem się psychicznie od tej presji, ale nauczyło mnie to dyscypliny. Sport to zawsze była duża część mojego życia — od zawsze kochałem pływać, grałem w siatkówkę w podstawówce i liceum gdzie zostałem dobrze wytrenowany, a siłownię zacząłem dopiero w Belgii po przeprowadzce na studia (bardzo mi się spodobało). W liceum odkryłem miłość do gier studiując matematykę, fizykę i informatykę. Zacząłem robić skrypty żeby mieć unfair advantage — najpierw w Minecraft, potem CS:GO, potem w każdej mainstreamowej grze. Uwielbiałem automatyzować rzeczy skryptami w Pythonie i Lua. Potem znalazłem niesamowity film Dr. Aleksandra Deweppe o kierunku Game Sound Integration w Belgii. Postanowiłem zaryzykować i przejechać 1400 km z Polski do Zachodniej Flandrii. Najlepsza decyzja w życiu.',
          nl:'Mijn passie voor audio begon toen mijn vader thuis rockklassiekers draaide — daar werd ik voor het eerst verliefd op muziek. Mijn ouders schreven me in voor muziekschool en 6 jaar lang werd ik vaak gedwongen om piano te spelen. De school was brute, zoals iets uit het communistische tijdperk — strenge leraren, onmogelijke eisen. Ik had bijna een zenuwinzinking van de druk, maar het leerde me discipline. Sport is altijd een groot deel van mijn leven geweest — ik houd al sinds altijd van zwemmen, speelde volleybal tijdens de basisschool en middelbare school waar ik goed getraind werd, en begon pas met de sportschool na mijn verhuizing naar België voor mijn studies (werd er verliefd op). Op de middelbare school ontdekte ik mijn liefde voor games tijdens het studeren van wiskunde, natuurkunde en informatica. Ik begon scripts te maken om unfair advantages te krijgen — eerst in Minecraft, dan CS:GO, toen elke mainstream game die ik speelde. Ik hield van het automatiseren van dingen met Python en Lua scripts. Toen vond ik deze geweldige video van Dr. Alexander Deweppe over het Game Sound Integration programma in België. Ik besloot alles te riskeren en 1400 km te reizen van Polen naar West-Vlaanderen. Beste beslissing ooit.'
        },
