document.addEventListener('DOMContentLoaded', function() {
  ...
  const I18N = {
    ...
    // Music carousel genres
    genre_all_tracks: { en:'All Tracks', pl:'Wszystkie utwory', nl:'Alle Tracks' },
    genre_electronic: { en:'Electronic', pl:'Electronic', nl:'Electronic' },
    genre_film: { en:'Film', pl:'Film', nl:'Film' },
    genre_metal: { en:'Metal', pl:'Metal', nl:'Metal' },
    genre_playful: { en:'Playful', pl:'Zabawne', nl:'Speels' },
    genre_score: { en:'Score', pl:'Muzyka filmowa', nl:'Score' },
    genre_single: { en:'Single', pl:'Singiel', nl:'Single' },
    music_search_placeholder: { en:'🔍 Search tracks...', pl:'🔍 Szukaj utworów...', nl:'🔍 Zoek tracks...' },
    ...
    projects_search_placeholder: { pl: '🔍 Szukaj projektów po nazwie lub typie...', nl: '🔍 Zoek projecten op naam of type...', en: '🔍 Search projects by name or type...' },
    ...
    ue_meta_language: { en: 'Language', pl: 'Język', nl: 'Taal' },
    ue_meta_status: { en: 'Status', pl: 'Status', nl: 'Status' },
    ue_meta_status_value: { en: 'Open Source', pl: 'Open Source', nl: 'Open Source' },
    ue_button_github: { en: 'View on GitHub', pl: 'Zobacz na GitHub', nl: 'Bekijk op GitHub' },
    ue_button_download: { en: 'Download Latest Release', pl: 'Pobierz najnowszą wersję', nl: 'Download nieuwste versie' },
    ue_overview_title: { en: 'Overview', pl: 'Przegląd', nl: 'Overzicht' },
    ue_overview_desc: { en: 'Unreal Engine Rebuilder started as a simple solution to a common problem: repetitive project maintenance tasks that waste valuable development time. What began as a batch script evolved into a comprehensive C# application with a modern GUI, designed to streamline the entire Unreal Engine development workflow. I created this tool to make life easier for myself and fellow students working with Unreal Engine, and it has proven invaluable in day-to-day development.', pl: 'Unreal Engine Rebuilder rozpoczął się jako proste rozwiązanie powszechnego problemu: powtarzalnych zadań konserwacji projektów, które marnują cenny czas programistyczny. To, co zaczęło się jako skrypt wsadowy, przekształciło się w kompleksową aplikację C# z nowoczesnym GUI, zaprojektowaną do usprawnienia całego przepływu pracy w Unreal Engine. Stworzyłem to narzędzie, aby ułatwić życie sobie i innym studentom pracującym z Unreal Engine, i okazało się bezcenne w codziennym rozwoju.', nl: 'Unreal Engine Rebuilder begon als een eenvoudige oplossing voor een veelvoorkomend probleem: repetitieve projectonderhoudstaken die waardevolle ontwikkelingstijd verspillen. Wat begon als een batch-script evolueerde naar een uitgebreide C#-applicatie met een moderne GUI, ontworpen om de hele Unreal Engine ontwikkelingsworkflow te stroomlijnen. Ik creëerde deze tool om het leven gemakkelijker te maken voor mezelf en medestudenten die met Unreal Engine werken, en het is van onschatbare waarde gebleken in dagelijkse ontwikkeling.' },
    ue_stat_minutes: { en: 'Minutes Saved Per Build', pl: 'Minut zaoszczędzonych na build', nl: 'Minuten bespaard per build' },
    ue_stat_gb: { en: 'GB Disk Space Reclaimed', pl: 'GB miejsca na dysku odzyskane', nl: 'GB schijfruimte teruggewonnen' },
    ue_stat_automation: { en: 'Automation Coverage', pl: 'Pokrycie automatyzacji', nl: 'Automatiseringsdekking' },
    ue_features_title: { en: 'Key Features', pl: 'Kluczowe funkcje', nl: 'Belangrijkste kenmerken' },
    ue_feature_rebuild_title: { en: 'Total Rebuild Clean', pl: 'Całkowite przebudowanie i czyszczenie', nl: 'Totale rebuild en opruiming' },
    ue_feature_rebuild_desc: { en: 'Complete project refresh: removes Binaries, Intermediate, and Saved folders, regenerates Visual Studio solution, and compiles the project with build time tracking.', pl: 'Kompletne odświeżenie projektu: usuwa foldery Binaries, Intermediate i Saved, regeneruje rozwiązanie Visual Studio i kompiluje projekt ze śledzeniem czasu budowania.', nl: 'Complete projectverversing: verwijdert Binaries, Intermediate en Saved mappen, regenereert Visual Studio oplossing en compileert het project met build time tracking.' },
    ue_feature_backup_title: { en: 'Automated Backups', pl: 'Automatyczne kopie zapasowe', nl: 'Geautomatiseerde back-ups' },
    ue_feature_backup_desc: { en: 'One-click project archiving with smart compression, timestamped archives, and selective backup of essential files (Source/Config/Content/Plugins).', pl: 'Archiwizacja projektu jednym kliknięciem z inteligentną kompresją, archiwami oznaczonymi datą i selektywną kopią zapasową niezbędnych plików (Source/Config/Content/Plugins).', nl: 'Eén-klik projectarchivering met slimme compressie, getimede archieven en selectieve back-up van essentiële bestanden (Source/Config/Content/Plugins).' },
    ue_feature_disk_title: { en: 'Disk Management', pl: 'Zarządzanie dyskiem', nl: 'Schijfbeheer' },
    ue_feature_disk_desc: { en: 'Detailed folder size breakdown with DDC cleaning that can free up gigabytes instantly. Smart formatting shows human-readable sizes with before/after stats.', pl: 'Szczegółowy podział rozmiaru folderów z czyszczeniem DDC, które może natychmiast uwolnić gigabajty. Inteligentne formatowanie pokazuje czytelne rozmiary ze statystykami przed/po.', nl: 'Gedetailleerde mapgrootte-uitsplitsing met DDC-opruiming die direct gigabytes kan vrijmaken. Slimme opmaak toont leesbare groottes met voor/na statistieken.' },
    ue_feature_detection_title: { en: 'Intelligent Detection', pl: 'Inteligentne wykrywanie', nl: 'Intelligente detectie' },
    ue_feature_detection_desc: { en: 'Auto-finds UE installations by scanning drives and checking Windows Registry. Supports multiple UE versions (4.x and 5.x) with fallback GUI folder picker.', pl: 'Automatycznie znajduje instalacje UE skanując dyski i sprawdzając rejestr Windows. Obsługuje wiele wersji UE (4.x i 5.x) z rezerwowym GUI do wyboru folderu.', nl: 'Vindt automatisch UE-installaties door schijven te scannen en het Windows-register te controleren. Ondersteunt meerdere UE-versies (4.x en 5.x) met fallback GUI map selector.' },
    ue_feature_logging_title: { en: 'Professional Logging', pl: 'Profesjonalne logowanie', nl: 'Professionele logging' },
    ue_feature_logging_desc: { en: 'Automatic documentation of every operation with timestamped files, auto-cleanup of logs older than 30 days, and detailed error reporting.', pl: 'Automatyczna dokumentacja każdej operacji z plikami oznaczonymi datą, automatyczne czyszczenie logów starszych niż 30 dni i szczegółowe raportowanie błędów.', nl: 'Automatische documentatie van elke operatie met getimede bestanden, auto-opruiming van logs ouder dan 30 dagen en gedetailleerde foutrapportage.' },
    ue_feature_ui_title: { en: 'Modern Interface', pl: 'Nowoczesny interfejs', nl: 'Moderne interface' },
    ue_feature_ui_desc: { en: 'Dark theme with custom borderless title bar, color-coded buttons for visual distinction, and real-time console feedback with green terminal text.', pl: 'Ciemny motyw z niestandardowym paskiem tytułowym bez ramki, kolorowo zakodowane przyciski dla wizualnego rozróżnienia i feedback konsoli w czasie rzeczywistym z zielonym tekstem terminala.', nl: 'Donker thema met aangepaste randloze titelbalk, kleurgecodeerde knoppen voor visueel onderscheid en real-time console feedback met groene terminaltekst.' },
    ue_technical_title: { en: 'Technical Implementation', pl: 'Implementacja techniczna', nl: 'Technische implementatie' },
    ue_technical_desc: { en: 'Built with C# and .NET, the application features a modern WPF interface with async/await patterns for non-blocking operations. The architecture includes smart engine detection, comprehensive error handling, and state management for reliable operation.', pl: 'Zbudowana w C# i .NET, aplikacja posiada nowoczesny interfejs WPF ze wzorcami async/await dla operacji nieblokujących. Architektura obejmuje inteligentne wykrywanie silnika, kompleksową obsługę błędów i zarządzanie stanem dla niezawodnego działania.', nl: 'Gebouwd met C# en .NET, heeft de applicatie een moderne WPF-interface met async/await patronen voor non-blocking operaties. De architectuur omvat slimme engine-detectie, uitgebreide foutafhandeling en staatsbeheer voor betrouwbare werking.' },
    ue_workflows_title: { en: 'Common Workflows', pl: 'Typowe przepływy pracy', nl: 'Gangbare workflows' },
    ue_workflow_daily_title: { en: 'Daily Development', pl: 'Codzienny rozwój', nl: 'Dagelijkse ontwikkeling' },
    ue_workflow_daily_1: { en: 'Morning: Launch Editor', pl: 'Rano: uruchom edytor', nl: 'Ochtend: Start Editor' },
    ue_workflow_daily_2: { en: 'Before Commit: Create Backup', pl: 'Przed commitem: utwórz kopię zapasową', nl: 'Voor Commit: Maak back-up' },
    ue_workflow_daily_3: { en: 'End of Day: Clean Only', pl: 'Koniec dnia: tylko czyszczenie', nl: 'Einde van de dag: Alleen opruimen' },
    ue_workflow_problem_title: { en: 'Problem Solving', pl: 'Rozwiązywanie problemów', nl: 'Probleemoplossing' },
    ue_workflow_problem_1: { en: 'Build Errors: Rebuild Visual Studio', pl: 'Błędy budowania: przebuduj Visual Studio', nl: 'Build fouten: Rebuild Visual Studio' },
    ue_workflow_problem_2: { en: 'Corrupted Project: Total Rebuild Clean', pl: 'Uszkodzony projekt: całkowite przebudowanie i czyszczenie', nl: 'Corrupt project: Totale rebuild en opruiming' },
    ue_workflow_problem_3: { en: 'Low Disk Space: Clean DDC', pl: 'Mało miejsca na dysku: wyczyść DDC', nl: 'Weinig schijfruimte: Ruim DDC op' },
    ue_workflow_weekly_title: { en: 'Weekly Maintenance', pl: 'Cotygodniowa konserwacja', nl: 'Wekelijks onderhoud' },
    ue_workflow_weekly_1: { en: 'Monday: Disk Usage Analysis', pl: 'Poniedziałek: analiza użycia dysku', nl: 'Maandag: Schijfgebruik analyse' },
    ue_workflow_weekly_2: { en: 'Wednesday: Create Backup', pl: 'Środa: utwórz kopię zapasową', nl: 'Woensdag: Maak back-up' },
    ue_workflow_weekly_3: { en: 'Friday: Deep Clean (DDC + Clean)', pl: 'Piątek: głębokie czyszczenie (DDC + Clean)', nl: 'Vrijdag: Grondig opruimen (DDC + Clean)' },
    ue_motivation_title: { en: 'Why I Built This', pl: 'Dlaczego to stworzyłem', nl: 'Waarom ik dit bouwde' },
    ue_motivation_desc: { en: 'As a student working with Unreal Engine, I found myself repeatedly performing the same tedious tasks: cleaning build artifacts, regenerating project files, managing disk space. These operations were necessary but time-consuming, taking 5-10 minutes each time. I wanted to automate these workflows so I could focus on what matters: actual development.', pl: 'Jako student pracujący z Unreal Engine, ciągle wykonywałem te same żmudne zadania: czyszczenie artefaktów budowania, regenerowanie plików projektu, zarządzanie miejscem na dysku. Te operacje były konieczne, ale czasochłonne, zajmując 5-10 minut za każdym razem. Chciałem zautomatyzować te przepływy pracy, aby móc skupić się na tym, co ważne: rzeczywistym rozwoju.', nl: 'Als student die met Unreal Engine werkte, merkte ik dat ik herhaaldelijk dezelfde vervelende taken uitvoerde: build artefacten opruimen, projectbestanden regenereren, schijfruimte beheren. Deze operaties waren noodzakelijk maar tijdrovend, 5-10 minuten per keer. Ik wilde deze workflows automatiseren zodat ik me kon concentreren op wat belangrijk is: daadwerkelijke ontwikkeling.' },
    ue_motivation_desc2: { en: 'The tool evolved from personal scripts into a full application that my peers could use too. Seeing other students benefit from it and save time on their projects made the development effort worthwhile. It\'s now an essential part of my Unreal Engine workflow, and I continue to improve it based on real-world usage and feedback.', pl: 'Narzędzie przekształciło się z osobistych skryptów w pełną aplikację, z której mogą korzystać także moi koledzy. Widząc, że inni studenci korzystają z niego i oszczędzają czas na swoich projektach, uznałem wysiłek programistyczny za wart zachodu. Jest teraz niezbędną częścią mojego przepływu pracy w Unreal Engine i nadal go ulepszam w oparciu o rzeczywiste użycie i feedback.', nl: 'De tool evolueerde van persoonlijke scripts naar een volledige applicatie die mijn collega-studenten ook konden gebruiken. Het zien dat andere studenten er profijt van hadden en tijd bespaarden op hun projecten, maakte de ontwikkelingsinspanning de moeite waard. Het is nu een essentieel onderdeel van mijn Unreal Engine workflow, en ik blijf het verbeteren op basis van praktijkgebruik en feedback.' },
    ue_cta_title: { en: 'Get Started', pl: 'Zacznij', nl: 'Aan de slag' },
