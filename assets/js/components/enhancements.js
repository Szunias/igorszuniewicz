  ...
  function translatePage(lang){
    ...
    if (location.pathname.endsWith('/about.html') || document.querySelector('.about-hero')){
      const A = {
        ...
        about_paragraph: {
          en:'My passion for audio started with my dad blasting rock classics at home — that\'s where I first fell in love with music. My parents signed me up for music school, and for 6 years I was often forced to practice piano. The school was brutal, like something from the communist era — strict teachers, impossible standards. I nearly had a mental breakdown from the pressure, but it taught me discipline. In high school, I discovered my love for games while studying math, physics, and computer science. I started making scripts to get unfair advantages — first in Minecraft, then CS:GO, then whatever mainstream game I was playing. I loved automating things with Python and Lua scripts. Then I found this amazing video by Dr. Alexander Deweppe about the Game Sound Integration program in Belgium. I decided to risk everything and travel 1400 km from Poland to West Flanders. Best decision ever. Here I learned proper audio processing in DAWs and middleware, plus serious programming in C# and C++.',
          pl:'Moja pasja do audio zaczęła się od tego, że tata puszczał mi rockowe klasyki — wtedy po raz pierwszy zakochałem się w muzyce. Rodzice zapisali mnie do szkoły muzycznej i przez 6 lat często byłem zmuszany do gry na fortepianie. Szkoła była brutalna, jak z czasów PRL-u — surowi nauczyciele, niemożliwe wymagania. Prawie załamałem się psychicznie od tej presji, ale nauczyło mnie to dyscypliny. W liceum odkryłem miłość do gier studiując matematykę, fizykę i informatykę. Zacząłem robić skrypty żeby mieć unfair advantage — najpierw w Minecraft, potem CS:GO, potem w każdej mainstreamowej grze. Uwielbiałem automatyzować rzeczy skryptami w Pythonie i Lua. Potem znalazłem niesamowity film Dr. Aleksandra Deweppe o kierunku Game Sound Integration w Belgii. Postanowiłem zaryzykować i przejechać 1400 km z Polski do Zachodniej Flandrii. Najlepsza decyzja w życiu. Tutaj nauczyłem się porządnej obróbki dźwięku w DAW i middleware, plus solidnego programowania w C# i C++.',
          nl:'Mijn passie voor audio begon toen mijn vader thuis rockklassiekers draaide — daar werd ik voor het eerst verliefd op muziek. Mijn ouders schreven me in voor muziekschool en 6 jaar lang werd ik vaak gedwongen om piano te spelen. De school was brute, zoals iets uit het communistische tijdperk — strenge leraren, onmogelijke eisen. Ik had bijna een zenuwinzinking van de druk, maar het leerde me discipline. Op de middelbare school ontdekte ik mijn liefde voor games tijdens het studeren van wiskunde, natuurkunde en informatica. Ik begon scripts te maken om unfair advantages te krijgen — eerst in Minecraft, dan CS:GO, toen elke mainstream game die ik speelde. Ik hield van het automatiseren van dingen met Python en Lua scripts. Toen vond ik deze geweldige video van Dr. Alexander Deweppe over het Game Sound Integration programma in België. Ik besloot alles te riskeren en 1400 km te reizen van Polen naar West-Vlaanderen. Beste beslissing ooit. Hier leerde ik goede audioverwerking in DAWs en middleware, plus serieus programmeren in C# en C++.'
        },
        ...
        about_journey_text: {
          en:'Looking back, everything makes sense now. Those years of being forced to practice piano gave me a solid musical foundation, even though I hated it at the time. My gaming obsession in high school — writing Python scripts for Minecraft, Lua hacks for CS:GO — that was actually me learning to code without realizing it. I was just a kid who wanted to win at games, but I was accidentally becoming a programmer. When I found Dr. Deweppe\'s video about studying game audio in Belgium, it all clicked. Here was a way to combine everything I loved: music, games, and code. The 1400 km journey from Poland felt scary but necessary. Now I\'m learning how to make the audio that enhances the gaming experiences I grew up loving.',
          pl:'Patrząc wstecz, wszystko teraz ma sens. Te lata zmuszania do gry na fortepianie dały mi solidne fundamenty muzyczne, chociaż wtedy tego nienawidziłem. Moja obsesja na punkcie gier w liceum — pisanie skryptów w Pythonie do Minecraft, hacki w Lua do CS:GO — to właściwie nieuświadomiona nauka programowania. Byłem tylko dzieciakiem, który chciał wygrywać w gry, ale przypadkowo stawałem się programistą. Kiedy znalazłem film Dr. Deweppe o studiowaniu game audio w Belgii, wszystko się złożyło. To był sposób na połączenie wszystkiego co kocham: muzyki, gier i kodu. Ta podróż 1400 km z Polski wydawała się straszna, ale konieczna. Teraz uczę się, jak tworzyć audio, które wzbogaca doświadczenia z gier, z którymi dorastałem.',
          nl:'Terugkijkend slaat alles nu wel op. Die jaren van gedwongen pianospelen gaven me een solide muzikale basis, ook al haatte ik het destijds. Mijn gaming obsessie op de middelbare school — Python scripts schrijven voor Minecraft, Lua hacks voor CS:GO — dat was eigenlijk onbewust leren programmeren. Ik was gewoon een kind dat wilde winnen in games, maar werd per ongeluk een programmeur. Toen ik Dr. Deweppe\'s video vond over game audio studeren in België, viel alles op zijn plaats. Dit was een manier om alles wat ik liefhad te combineren: muziek, games en code. De 1400 km reis vanuit Polen voelde eng maar noodzakelijk. Nu leer ik hoe ik de audio maak die de gaming ervaringen verbetert waar ik mee opgroeide.'
        },
        about_philosophy_title: { en:'What Keeps Me Going', pl:'Co Mnie Napędza', nl:'Wat Mij Gaande Houdt' },
        about_philosophy_text: {
          en:'I\'m driven by the same thing that made me write those game scripts — I want to create something that makes people\'s experience better. Back then it was giving myself an edge in CS:GO, now it\'s about making game audio that pulls players deeper into the world. I love the technical challenges, but what really gets me excited is when someone plays a game and doesn\'t even notice the audio because it feels so natural and perfect. That\'s the goal — invisible magic. Whether I\'m tweaking milliseconds of latency or crafting the perfect reverb for a cave scene, I\'m always thinking about the person on the other side of the screen having the best possible experience.',
          pl:'Napędza mnie to samo, co kazało mi pisać tamte skrypty do gier — chcę tworzyć coś, co poprawia doświadczenie ludzi. Wtedy chodziło o przewagę w CS:GO, teraz o audio w grach, które wciąga graczy głębiej w świat. Uwielbiam wyzwania techniczne, ale naprawdę ekscytuje mnie to, gdy ktoś gra w grę i nawet nie zauważa audio, bo brzmi tak naturalnie i idealnie. To jest cel — niewidzialna magia. Czy to regulacja milisekund opóźnienia, czy tworzenie idealnego reverbu do sceny w jaskini — zawsze myślę o osobie po drugiej stronie ekranu, która ma mieć najlepsze możliwe doświadczenie.',
          nl:'Ik word gedreven door hetzelfde wat me die game scripts deed schrijven — ik wil iets creëren dat mensen\'s ervaring beter maakt. Toen ging het om mezelf een voorsprong geven in CS:GO, nu gaat het om game audio die spelers dieper de wereld in trekt. Ik hou van de technische uitdagingen, maar wat me echt opwindt is wanneer iemand een game speelt en de audio niet eens opmerkt omdat het zo natuurlijk en perfect aanvoelt. Dat is het doel — onzichtbare magie. Of ik nu milliseconden latentie aan het fine-tunen ben of de perfecte reverb voor een grotscène aan het maken, ik denk altijd aan de persoon aan de andere kant van het scherm die de best mogelijke ervaring moet hebben.'
        },
